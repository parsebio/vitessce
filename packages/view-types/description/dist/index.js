 ...
 */
{
  (function() {
    ...
    function checkPropTypes2(typeSpecs, values, location, componentName, element2) {
      {
    ...
    function validatePropTypes(element2) {
      {
        ...
        if (propTypes2) {
          ...
          checkPropTypes2(propTypes2, element2.props, "prop", name2, element2);
...
function createRule(name2, decl, options) {
  ...
  if (rule)
    return rule;
  if (name2[0] === "@") {
    warning(false, "[JSS] Unknown rule " + name2);
  }
  return null;
}
...
var StyleRule = /* @__PURE__ */ function(_BaseStyleRule) {
  ...
  _proto2.toString = function toString2(options) {
    ...
    var opts = link2 ? _extends$1({}, options, {
      allowEmpty: true
    }) : options;
...
var findReferencedKeyframe = function findReferencedKeyframe2(val, keyframes) {
  if (typeof val === "string") {
    return val.replace(refRegExp$1, function(match, name2) {
      if (name2 in keyframes) {
        return keyframes[name2];
      }
      warning(false, '[JSS] Referenced keyframes rule "' + name2 + '" is not defined.');
      return match;
    });
  }
  return val;
...
var RuleList = /* @__PURE__ */ function() {
  ...
  _proto.replace = function replace(name2, decl, ruleOptions) {
    ...
    this.registry = [].concat(this.plugins.external, this.plugins.internal).reduce(function(registry, plugin) {
      for (var name2 in plugin) {
        if (name2 in registry) {
          ...
          warning(false, '[JSS] Unknown hook "' + name2 + '".');
        }
      }
      return registry;
    }, {
...
function findCommentNode(text2) {
  ...
  for (var i = 0; i < head.childNodes.length; i++) {
    ...
    if (node2.nodeType === 8 && node2.nodeValue.trim() === text2) {
      return node2;
    }
  }
  return null;
...
var DomRenderer = /* @__PURE__ */ function() {
  function DomRenderer2(sheet) {
    ...
    if (sheet)
      sheets.add(sheet);
    this.sheet = sheet;
    var _ref = this.sheet ? this.sheet.options : {}, media = _ref.media, meta = _ref.meta, element2 = _ref.element;
    ...
    for (var prop in style) {
      ...
      if (isNested) {
        ...
        if ("replaceRule" in container) {
          container.replaceRule(name2, style[prop], _extends$1({}, options, {
            selector
          }));
        } else {
          container.addRule(name2, style[prop], _extends$1({}, options, {
            selector
          }));
        }
...
function getStylesCreator(stylesOrCreator) {
  ...
  return {
    create: function create3(theme, name2) {
      var styles;
      try {
      ...
      Object.keys(overrides).forEach(function(key) {
        {
          if (!stylesWithOverrides[key]) {
            console.warn(["Material-UI: You are trying to override a style that does not exist.", "Fix the `".concat(key, "` key of `theme.overrides.").concat(name2, "`.")].join("\n"));
          }
        }
...
function attach(_ref2, props) {
  var state = _ref2.state, theme = _ref2.theme, stylesOptions = _ref2.stylesOptions, stylesCreator = _ref2.stylesCreator, name2 = _ref2.name;
  if (stylesOptions.disableGeneration) {
    return;
  }
  ...
  if (sheetManager.refs === 0) {
    ...
    var styles = stylesCreator.create(theme, name2);
    if (!staticSheet) {
...
const minpath = { basename, dirname, extname, join: join2, sep: "/" };
...
function Description(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.description, children: [
    descriptionType && descriptionType === DescriptionType.MARKDOWN ? /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: description }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: description }),
...
function DescriptionSubscriber(props) {
  ...
  const [{ image: image2 }, imageStatus] = useImageData(
    loaders,
    dataset,
    false,
    {},

...
import React__default, { Children, isValidElement, cloneElement, useState, useRef, useMemo, useCallback, useEffect } from "react";
import { useViewConfigStoreApi, createLoaders, TitleInfo } from "@vitessce/vit-s";
...
function exactProp(propTypes2) {
  return _extends$1({}, propTypes2, _defineProperty$1({}, specialProperty, function(props) {
...
function createMixins(breakpoints, spacing, mixins) {
  ...
  return _extends({
    gutters: function gutters() {
      ...
      }, styles7, _defineProperty({}, breakpoints.up("sm"), _extends({
...
var Jss = /* @__PURE__ */ function() {
  ...
  _proto.createStyleSheet = function createStyleSheet(styles7, options) {
    ...
    var sheet = new StyleSheet(styles7, _extends$1({}, options, {
      jss: this,
...
function getStylesCreator(stylesOrCreator) {
  ...
  return {
    create: function create2(theme, name) {
      ...
      var stylesWithOverrides = _extends$1({}, styles7);
...
function attach(_ref2, props) {
  ...
  if (sheetManager.refs === 0) {
    ...
    if (!staticSheet) {
      staticSheet = stylesOptions.jss.createStyleSheet(styles7, _extends$1({
        link: false
      }, options));
      staticSheet.attach();
      if (stylesOptions.sheetsCache) {
...
const SvgIcon$1 = withStyles2(styles$6, {
  name: "MuiSvgIcon"
})(SvgIcon);
...
const TouchRipple$1 = withStyles2(styles$5, {
  flip: false,
  name: "MuiTouchRipple"
...
const ButtonBase$1 = withStyles2(styles$4, {
  name: "MuiButtonBase"
})(ButtonBase);
...
const IconButton$1 = withStyles2(styles$3, {
  name: "MuiIconButton"
})(IconButton);
...
const SwitchBase$1 = withStyles2(styles$2, {
...
var styles$1 = function styles4(theme) {
  return {
    /* Styles applied to the root element. */
    root: {
...
const Checkbox$1 = withStyles2(styles$1, {
  name: "MuiCheckbox"
})(Checkbox);
...
var StyledGrid = withStyles2(styles5, {
  name: "MuiGrid"
})(Grid);
{
...
function LinkController(props) {
  ...
  const id = useMemo(() => `id_${Math.floor(Math.random() * 1e3)}`, []);
  ...
  const onConfigChange = useCallback((configValue) => {
    ...
    if (sync && socketOpen) {
      try {
        ...
        (_a = connection.current) == null ? void 0 : _a.send(JSON.stringify(message));
      } catch (error) {
          ...
          if (eventData.split(";")[0] === id) {
            ...
            if (sync) {
              setConfig({
                ...
                uid: `id${Math.floor(Math.random() * 1e3)}`
              });
            }
          }
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { textAlign: "justify" }, children: [
      "To join the same session navigate to ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://vitessce.link", children: "https://vitessce.link" }),
      " and enter the ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Link ID" }),
      " displayed here in the view. The session is synced as long as the ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Link Active" }),
      " Checkbox is activated."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Grid$1, { container: true, direction: "row", style: { gridGap: "10px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Grid$1, { item: true, xs: 5, style: { whiteSpace: "nowrap" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "25px" }, children: [
        "Link ID:  ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: linkID })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Grid$1, { item: true, xs: 5, style: { fontSize: "25px", whiteSpace: "nowrap" }, children: [
        "Link Active: ",
...
function LinkControllerSubscriber(props) {
  const {
    removeGridComponent,
    theme,
    title = "Vitessce Link",
